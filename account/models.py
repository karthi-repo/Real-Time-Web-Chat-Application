...
class Account(AbstractBaseUser):
    ...
    profile_image = models.ImageField(max_length=255, upload_to=get_profile_image_fillepath, null=True, default=get_default_profile_image)
    hide_email = BooleanField(default=True)
